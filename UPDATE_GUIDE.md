...
## Step 8: Write End-User Release Notes

After the GitHub Release is published, update its body with an end-user-focused summary.
...
Once the GitHub Release exists, run:

```bash
gh release edit <tag> --repo foro-fmt/foro-clang-format --notes "$(cat <<'NOTES'
